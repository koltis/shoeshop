...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create shoes-company-5e61
  fly apps create shoes-company-5e61-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app shoes-company-5e61
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app shoes-company-5e61-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'shoes-company-5e61-staging' does not match app name in config file 'shoes-company-5e61'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name shoes-company-5e61-db
  fly postgres attach --app shoes-company-5e61 shoes-company-5e61-db

  fly postgres create --name shoes-company-5e61-staging-db
  fly postgres attach --app shoes-company-5e61-staging shoes-company-5e61-staging-db
  ```
